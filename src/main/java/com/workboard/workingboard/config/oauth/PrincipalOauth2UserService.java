...
import com.workboard.workingboard.config.oauth.provider.GithubUserInfo;
import com.workboard.workingboard.config.oauth.provider.GoogleUserInfo;
import com.workboard.workingboard.config.oauth.provider.NaverUserInfo;
import com.workboard.workingboard.config.oauth.provider.OAuth2UserInfo;
